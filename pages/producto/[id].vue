...
<template>
    <section class="py-8">
        <div class=" mx-auto px-8">
            ...
            <div class="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12  lg:grid-cols-5 lg:gap-16">
                <div class="lg:col-span-3 lg:row-end-1 ">
                    <div class="lg:flex lg:items-start">
                        <div class="lg:order-2 lg:ml-5">
                            <div class="max-w-xl overflow-hidden rounded-lg">
                                <img class="h-full w-full max-w-full object-cover"
                                    :src="'https://http2.mlstatic.com/D_' + imageZoom + '-O.webp'" alt="" />
                            </div>
                        </div>

                        <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                            <div class="flex flex-row items-start lg:flex-col">
                                <button type="button" @click="imageZoom = data.id"
                                    v-for="(data, index) in producto.pictures"
                                    :class="imageZoom == data.id ? 'border-primary' : 'border-secondary'" :key="index"
                                    class="flex-0 aspect-square mb-3 border-2 h-16 overflow-hidden rounded-lg  mr-4 text-center">
                                    <img class="h-full w-full object-cover"
                                        :src="'https://http2.mlstatic.com/D_' + data.id + '-O.webp'" alt="" />
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class=" lg:col-span-2 lg:row-span-2 lg:row-end-2">
                    <div class="sticky top-20">
                        <p class=" text-sm font-medium text-gray-500">Nuevo | +{{ producto.sold_quantity }} vendidos</p>
                        <h1 class=" sm: text-2xl font-bold text-gray-900 sm:text-3xl">{{ producto.title }}</h1>
                        ...
                        <div
                            ...
                            <div class="flex items-end">
                                <h1 class="text-3xl font-bold">U$D {{ producto.price }}</h1>
                        ...
                        <ul class="mt-8 space-y-2">
                            <li class="flex items-center text-left text-sm font-medium text-gray-600">
                                ...
                                <p class=" text-sm font-medium text-gray-500">{{ producto.warranty }}</p>
                            </li>
                ...
                <div class="lg:col-span-3">
                    ...
                    <ul class="mt-8 grid grid-cols-2">
                        <li v-for="atributo in producto.attributes">
    ...
    <h2 class="text-2xl text-bold px-4 ">Productos Relacionados</h2>
